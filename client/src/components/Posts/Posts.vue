                        ...
                        <v-card-text v-show="showPostCreator" class="grey lighten-4">
                            <v-list-item>
                                ...
                                <v-list-item-content>
                                    ...
                                    <v-list-item-subtitle class="font-weight-thin">Added {{ formatCreatedDate(post.createdDate) }}
        ...
        <v-layout v-if="showMoreEnabled" column>
            <v-flex xs12>
                <v-layout justify-center row>
                    <v-btn color="info" @click="showMorePosts">See More</v-btn>
                </v-layout>
            </v-flex>
        </v-layout>
